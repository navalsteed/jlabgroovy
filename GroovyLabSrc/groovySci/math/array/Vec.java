...
void putAt(groovy.lang.IntRange  range,  double value)  {
...
Vec getAt(groovy.lang.IntRange range) {
    int rs = range.getFrom(); int re = range.getTo();
...
public void set(int i, Number vn) {
    v[i] =  vn.doubleValue();
}
