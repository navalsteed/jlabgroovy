...
/**Function called when the gui is being close*/
      ...
      userOption = JOptionPane.showConfirmDialog(null, "File: "+GlobalValues.myGEdit.editedFileName+" not saved. Proceed? ", 
            ...
            if (userOption == JOptionPane.YES_OPTION)  {
                ...
                GlobalValues.myGEdit.currentFrame.dispose();
              
       
                File outPropFile = new File(GlobalValues.workingDir+File.separator+"Glab.props");
    try {
...
public void redirectConsole()  {
       ...
       // When GroovyLab is running within the Netbeans environment it is passed as the first program argument.          
            ...
            System.out.println("Detecting Paths");
   ...
   groovyLogoImage = Toolkit.getDefaultToolkit().getImage(groovyLogoImageURL);
	...
	try {
        ...
        if (GlobalValues.gLabMainFrame != null)  {
         ...
         GlobalValues.gLabMainFrame.setLocation(b.width/2, 20);
  ...
  if (explorerPanel != null)   {
     ...
     public void run() {  // run in  */
        ...
        gExec.gui.WatchClasses  watchClassesOfJTransforms = new gExec.gui.WatchClasses();
         ...
         int k=1;
         watchClassesOfJTransforms.displayClassesAndMethods( oregonDSPClasses, "Oregon DSP Library", gExec.gui.WatchClasses.watchXLoc+k*50, gExec.gui.WatchClasses.watchYLoc+k*50);
             }
                    });
        ...
        gExec.gui.WatchClasses  watchClassesOfCSparse  = new gExec.gui.WatchClasses();
         ...
         String csparseFile = JavaGlobals.javacFile.substring(0, JavaGlobals.javacFile.lastIndexOf("/")+1)+"csparsej.jar";
        ...
        gExec.gui.WatchClasses  watchClassesOfJTransforms = new gExec.gui.WatchClasses();
         ...
         String jtransformsFile = JavaGlobals.javacFile.substring(0, JavaGlobals.javacFile.lastIndexOf("/")+1)+"jtransforms.jar";
        ...
        gExec.gui.WatchClasses  watchClassesOfGroovySci = new gExec.gui.WatchClasses();
         ...
         watchClassesOfGroovySci.displayClassesAndMethodsAsString(coltClasses, "CERN Colt ", filterString,  gExec.gui.WatchClasses.watchXLoc+k*50, gExec.gui.WatchClasses.watchYLoc+k*50);
              ...
              htmlWithSystemBrowser.setText("Use System Browser for HTML help, Current State is "+GlobalValues.useSystemBrowserForHelp); 
                ...
                paneAdjustFontJMenuItem = new JMenuItem("Adjust Fonts of Interpreter Pane and GroovyLab edtor"); // configIcon);
          ...
          GlobalValues.GroovyShell.getContext().getVariables().clear();
              ...
              //  configAlphaParamJMenuItem = new JMenuItem(new configAlphaAction());
               // configAlphaParamJMenuItem.setFont(GlobalValues.uifont);
                ...
                confMenu.add(controlIndyJMenuItem);
                confMenu.add(controlDecimalsToDoublesJMenuItem);
                confMenu.add(controlDefaultlmportsJMenuItem);
                confMenu.add(resetGroovyShellJMenuItem);
                confMenu.add(resetGroovyShellLoadedClassesJMenuItem);
                confMenu.add(browseFileSysForPathsJMenuItem);
                confMenu.setFont(GlobalValues.uifont);
                confMenu.add(browseGroovySciJMenuItem);
                confMenu.add(controlPrecisionJMenuItem);
                confMenu.add(paneAdjustFontJMenuItem);
                confMenu.add(increaseRSyntaxFontMenuItem);
                confMenu.add(decreaseRSyntaxFontMenuItem);
                confMenu.add(adjustFontMenuItem);
                confMenu.add(outConsoleAdjustFontMenuItem);
                confMenu.add(adjustFontsUIMenuItem);
                confMenu.add(adjustFontspUIMenuItem);
                confMenu.add(adjustFontsgUIMenuItem);
                confMenu.add(adjustsFontsbUIMenuItem);
