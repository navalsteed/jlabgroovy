...
{  
    ...
    static public   String jdkTarget = "1.7";
    ...
    static public  boolean inspectClass = false;   // used for auto-completion,  inspect a class name or inspect an identifier
   ...
   static public boolean  rememberSizesFlag = true;
   ...
   static public boolean pathUpdateOnSaves = false;
    ...
    static public boolean displayAtOutputWindow = false;   // controls displaying at output window
        ...
        static public String TITLE="GroovyLab based on Groovy  "+org.codehaus.groovy.util.ReleaseInfo.getVersion()+"  ( "+ dateOfBuild+" ) ";
        ...
        static public    String  basicGlobalImports = 
                ...
                // JFreeChart imports
                  "import jplot.* \n"+
                  "import static jplot.jFigure.*; \n"+
                  "import static jplot.jPlot.*\n"+
...
// pass properties from the gLab workspace structures to the settings Property String to 
    public static void passPropertiesFromWorkspaceToSettings(Properties settings)
     ...
     settings.setProperty("paneFontSizeProp", String.valueOf(paneFontSize)); 
        ...
        TreeSet<String> nonDuplicateClassPaths = new TreeSet<String>();
